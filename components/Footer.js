  ...
  return (
    <div className='flex flex-col h-200px justify-center w-1440 items-center content-between border-2 bg-portal7  text-white font-lato mr-0 ml-0'>
      ...
      <div className='flex flex-row justify-between mb-10 '>
        ...
        <svg width="25" height="25" className='mr-12 fill-current text-portal2 hover:text-portal3' fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg width="25" className='mr-12 fill-current text-portal2 hover:text-portal3' height="20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg width="24" className='mr-12 fill-current text-portal2 hover:text-portal3' height="24" fill="none" xmlns="http://www.w3.org/2000/svg">
       ...
       <svg width="25" className='fill-current text-portal2 hover:text-portal3' height="19" fill="none" xmlns="http://www.w3.org/2000/svg">
