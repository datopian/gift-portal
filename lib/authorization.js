 ...
 */
export function isValidScope(organization, dataset, requestScope){
 const validScopes = ['read', 'write', 'admin']
  if(!validScopes.includes(requestScope)) {
    throw new Error(`Invalid scope. Scope should be of form "${organization}/${dataset}:read/write/admin"`)
  }
}
