export const processMultipleRepos = async (repos) => {
  ...
  return new Promise((resolve) => {
    ...
    repoNames.forEach((repoName, i) => {
      ...
      data["format"] = repo["author"] || "";
      data["encoding"] = repo["encoding"] || "";
      data["continent"] = repo["continent"] || "";
      data["country"] = repo["country"] || "";
      data["region"] = repo["region"] || "";
      data["city"] = repo["city"] || "";
      data["author_website"] = repo["author_website"] || "";
      data["author_email"] = repo["author_email"] || "";
      data["start_date"] = repo["start_date"] || "";
      data["end_date"] = repo["end_date"] || "";
      data["logo"] = repo["logo"] || ""
